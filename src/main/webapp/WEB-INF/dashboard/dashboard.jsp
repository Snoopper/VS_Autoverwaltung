...
<template:base>
    ...
    <jsp:attribute name="menu">
        ...
        <div class="menuitem">
            <a href="<c:url value="/app/tasks/task/new/"/>">Auto anlegen</a>
        </div>
        ...
        <div class="menuitem">
            <a href="<c:url value="/app/tasks/benutzerverwaltung/"/>">Benutzer bearbeiten</a>
        </div>
    </jsp:attribute>
    ...
    <jsp:attribute name="content">
        <c:choose>
            ...
            <c:otherwise>
                <jsp:useBean id="utils" class="dhbwka.wwi.vertsys.javaee.vs_autoverwaltung.common.web.WebUtils"/>
